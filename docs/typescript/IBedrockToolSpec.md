...
```typescript
import { IBedrockToolSpec } from 'xpander-sdk';
```
...
| Property | Value |
|----------|-------|
| **Type** | `IBedrockToolSpecInputSchema` |
| **Required** | ✅ Required |
| **Access** | ✏️ Read/Write |
...
<details>
<summary>📝 TypeScript IBedrockToolSpec Usage</summary>

```typescript
import { IBedrockToolSpec } from 'xpander-sdk';

// Work with IBedrockToolSpec - properties found dynamically
