...
```typescript
import { IToolExecutionResult } from 'xpander-sdk';
```
...
<details>
<summary>📝 TypeScript IToolExecutionResult Usage</summary>

```typescript
import { IToolExecutionResult } from 'xpander-sdk';

// Work with IToolExecutionResult - properties found dynamically
