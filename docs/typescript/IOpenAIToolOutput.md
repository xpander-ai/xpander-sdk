...
```typescript
import { IOpenAIToolOutput } from 'xpander-sdk';
```
...
| Property | Value |
|----------|-------|
| **Type** | `IOpenAIToolFunctionOutput` |
| **Required** | ✅ Required |
| **Access** | ✏️ Read/Write |
...
<details>
<summary>📝 TypeScript IOpenAIToolOutput Usage</summary>

```typescript
import { IOpenAIToolOutput } from 'xpander-sdk';

// Work with IOpenAIToolOutput - properties found dynamically
