...
```typescript
import { IBedrockToolSpecInputSchema } from 'xpander-sdk';
```
...
<details>
<summary>📝 TypeScript IBedrockToolSpecInputSchema Usage</summary>

```typescript
import { IBedrockToolSpecInputSchema } from 'xpander-sdk';

// Work with IBedrockToolSpecInputSchema - properties found dynamically
