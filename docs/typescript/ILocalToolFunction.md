...
```typescript
import { ILocalToolFunction } from 'xpander-sdk';
```
...
<details>
<summary>📝 TypeScript ILocalToolFunction Usage</summary>

```typescript
import { ILocalToolFunction } from 'xpander-sdk';

// Work with ILocalToolFunction - properties found dynamically
