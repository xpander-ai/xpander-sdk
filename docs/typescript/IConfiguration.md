...
```typescript
import { IConfiguration } from 'xpander-sdk';
```
...
<details>
<summary>📝 TypeScript IConfiguration Usage</summary>

```typescript
import { IConfiguration } from 'xpander-sdk';

// Create IConfiguration instance
const iconfiguration = new IConfiguration();


// Access key property: apiKey
const value = iconfiguration.apiKey;
console.log(`apiKey: ${value}`);




console.log("IConfiguration ready!");
```
